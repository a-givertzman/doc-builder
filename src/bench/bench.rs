...
fn main() {
    ...
    let target = Path::new("./");
    let src = Path::new("./");
    convert_markdown2html_converter(target, DocDir::new(src));
    // convert_markdown(DocDir::new(src));
}
///
        ...
        let html = markdown::to_html_with_options(
            ...
            &markdown::Options {
                ...
                compile: markdown::CompileOptions { 
                    ...
                    allow_dangerous_protocol: Default::default(), 
                    allow_any_img_src: Default::default(),
